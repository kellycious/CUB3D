...
/*   Updated: 2023/05/09 23:15:33 by fwong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_assign_elements(t_map *map, t_elements *element, int i, int j)
{
	if (ft_strncmp(map->cub[i] + j, "NO ", 3) && element->no == false)
		...
		element->floor	= true;
			...
			|| (ft_strncmp(map->cub[i] + j, "NO", 2) && element->so == true)
			|| (ft_strncmp(map->cub[i] + j, "NO", 2) && element->we == true)
			|| (ft_strncmp(map->cub[i] + j, "NO", 2) && element->ea == true)
			|| (ft_strncmp(map->cub[i] + j, "NO", 2) && element->ceiling == true)
			|| (cft_strncmp(map->cub[i] + j, "NO", 2) && element->floor == true))

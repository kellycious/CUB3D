...
/*   Updated: 2023/05/16 16:52:52 by fwong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_elements(t_map *map, t_elements *elements)
{
	...
	if (elements->no == false || elements->so == false || elements->we == false
		|| elements->ea == false || elements->ceiling == false || elements->floor == false)
		ft_error("ERROR: missing element(s)\n");
}

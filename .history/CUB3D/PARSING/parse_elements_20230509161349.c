...
/*   Updated: 2023/05/09 16:13:49 by fwong            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_assign_elements(t_map *map, t_elements *elements, int i, int j)
{
	if (ft_strncmp(map->cub[i][j], "NO ", 3) && elements->no == false)
		element->no = true;

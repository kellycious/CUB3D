...
void	r_left(t_map *game)
{
	...
	game->ray.dirx = game->ray.dirx * cos(0.15 / 2)
		- game->ray.diry * sin(0.15 / 2);
	game->ray.diry = old_dirx * sin(0.15 / 2)
		+ game->ray.diry * cos(0.15 / 2);
	game->ray.planx = game->ray.planx * cos(0.15 / 2)
		- game->ray.plany * sin(0.15 / 2);
	game->ray.plany = old_planex * sin(0.15 / 2)
		+ game->ray.plany * cos(0.15 / 2);
}
